...
iabbrev date<c-a>  <c-r>=strftime("%F")<cr>
inoremap <c-d> <c-v><c-a><c-[>a

iabbrev dt<c-a>  <c-r>=strftime("%a\ %b\ %e\ %I:%M\ %p")<cr>
inoremap <c-d> <c-v><c-a><c-[>a
...
map ,ctd :!ctags --langmap=php:.engine.inc.module.theme.php --php-kinds=cdfi --languages=php --recurse
map ,q :q<CR>
